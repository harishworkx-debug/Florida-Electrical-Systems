  ...
  return (
    <>
      <SEO
        ...
        description="Florida Electrical Systems serves Lakeland, Bartow, Winter Haven, Auburndale, Mulberry, Plant City, Haines City, Davenport, Lake Wales & more across Polk County, FL. Call (863) 281-0077."
